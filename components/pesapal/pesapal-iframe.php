...
$callback_url = SITE_PATH.'?content=com_pesapal&folder=same&file=paymentconfirm&sourceid='.$_POST['sourceid'].'&from='.$_GET['from'].'&itemid='.$id; //redirect url, the page that will handle the response from pesapal.
