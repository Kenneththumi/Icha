...
{
	public function calculatePages($total_rows, $rows_per_page, $page_num='1')
	{
		$arr = array();
		// calculate last page
		...
		$arr['pages'] = $this->getOuterPages($page_num, $last_page, $arr['next'],$last_page);
		return $arr;
	}
	
	function getOuterPages($page_num, $last_page, $next, $show=100)
	{
