...
if($_SERVER['HTTP_HOST']!='localhost')
{
    ...
    $base_url="http://".$_SERVER['HTTP_HOST'].'/cdi';  // DON'T TOUCH (base url (only domain) of site (without final /)).
}
...
//**********************
$ext_img = array('svg'); //Images
$ext_file = array('pdf'); //Files
$ext_video = array("webm"); //Video 
$ext_music = array('ogg'); //Audio
$ext_misc = array('dmg'); //Archives
...
$hidden_folders = array('registration');
...
$fixed_path_from_filemanager            = array('../../../../media/','../../../../media/'); //fixed path of the image folder from the current position on upload folder
