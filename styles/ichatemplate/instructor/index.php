...
<head>
<title><?php echo SITENAME ?> Instructor</title>
...
$skin->loadcss(array('ichatemplate/instructor','instructortemplate_css'));
...
<div id="container">
  <div id="top">
    <div id="logo">
        <?php
        if($_SESSION['usertype']=='ins')
        {
        ?>
        <img src="<?php echo STYLES_PATH ?>ichatemplate/instructor/images/icha_instructor_logo.png" />
        <?php
        }
        elseif($_SESSION['usertype']=='superinstructor'){
        ?>
        <img src="<?php echo STYLES_PATH ?>ichatemplate/instructor/images/systemlogo.png" />
        <?php
        }
        ?>
    </div>
  ...
  <div id="leftmenu">
      <?php
           $params = array(
                                'showicons' => 'yes',
                                'icopath' => STYLES_PATH.$skin->set_template.'/instructor/images/',
                                'icosuffix' => '_icon'
                            );
      
            $nav->loadmenu('ins',$params);
      ?>
      </div>
      <div id="maincontent">
	<?php
        
            $skin->loadcontent($_GET['instructor'],$_GET['folder'],$_GET['file']); 
        ?>
