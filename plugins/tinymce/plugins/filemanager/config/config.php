...
if($_SERVER['HTTP_HOST']!='localhost')
{
    ...
    $base_url="http://".$_SERVER['HTTP_HOST'].'/icha';  // DON'T TOUCH (base url (only domain) of site (without final /)).
}
...
$ext=array_merge($ext_file,$ext_img,$ext_video,$ext_music,$ext_misc); //allowed extensions
