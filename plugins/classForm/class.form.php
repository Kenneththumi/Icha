...
class form extends pfbc { 
	...
	public function __construct($id = "myform") {
		...
		$this->allowedFields = array(
			"form" => array("action", "accept", "accept-charset", "enctype", "method", "class", "dir", "id", "lang", "name", "style", "title", "xml:lang", "onclick", "ondblclick", "onmousedown", "onmousemove", "onmouseout", "onmouseover", "onmouseup", "onkeydown", "onkeypress", "onkeyup", "onreset"),
	...
	public function addCaptcha($label="", $additionalParams="") { echo 'here';
...
<script type="text/javascript">
	if(document.getElementById("{$this->attributes["id"]}"))
		document.getElementById("{$this->attributes["id"]}").style.visibility = "visible";
</script>
	...
	private function setIncludePaths() {
		...
		if(empty($this->jsIncludesPath)) {
                    if(strpos($this->phpIncludesPath, $_SERVER['DOCUMENT_ROOT']) === 0){ 
                        ...
                        $this->jsIncludesPath = "plugins/classForm/includes";
                    }
		}	
